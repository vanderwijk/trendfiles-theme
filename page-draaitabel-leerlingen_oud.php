							...
							<fieldset class="group" id="vragen-hbo">
								...
								<fieldset class="subgroup">
									...
									<ul>
										...
										<li>
											<label><input class="id_vakgebied_hbo" type="checkbox" value="1" name="id_vakgebied_hbo[]">AOT</label>
										</li>
										<li>
											<label><input class="id_vakgebied_hbo" type="checkbox" value="4" name="id_vakgebied_hbo[]">Werktuigbouwkunde</label>
										</li>
										<li>
											<label><input class="id_vakgebied_hbo" type="checkbox" value="2" name="id_vakgebied_hbo[]">Electrotechniek</label>
										</li>
										<li>
