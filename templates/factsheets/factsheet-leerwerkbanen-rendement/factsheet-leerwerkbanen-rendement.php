...
<script src="<?php echo $protocol . $host . '/wp-content/themes/trendfiles-theme/templates/factsheets/factsheet-leerwerkbanen-rendement/factsheet-leerwerkbanen-rendement.js'; ?>"></script>
		...
		<div class="col">
			<div class="block entry-content no-border">
				<svg id="factsheet-ti-installatie" width="1888" height="2699" viewBox="0 0 1888 2699" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<?php echo file_get_contents( $protocol . $host . '/wp-content/themes/trendfiles-theme/templates/factsheets/factsheet-leerwerkbanen-rendement/achtergrond.svg'); ?>
					<?php echo file_get_contents( $protocol . $host . '/wp-content/themes/trendfiles-theme/templates/factsheets/factsheet-leerwerkbanen-rendement/factsheet-leerwerkbanen-rendement.svg'); ?>
					...
					<?php echo file_get_contents( $protocol . $host . '/wp-content/themes/trendfiles-theme/templates/factsheets/factsheet-leerwerkbanen-rendement/data.svg'); ?>
				</svg>
			</div>
		</div>
	</div>
