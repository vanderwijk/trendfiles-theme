...
function maakGrafiek(regio, functie) {
	...
	jQuery( '#staaf_2016' ).css({ stroke: kleuren[regio].hoofdkleur });
	jQuery( '#staaf_2017' ).css({ stroke: kleuren[regio].hoofdkleur });
	jQuery( '#staaf_2018' ).css({ stroke: kleuren[regio].hoofdkleur });
	jQuery( '#staaf_2019' ).css({ stroke: kleuren[regio].hoofdkleur });
	jQuery( '#staaf_2020' ).css({ stroke: kleuren[regio].hoofdkleur });
	jQuery( '#staaf_2016_uitstroom' ).css({ stroke: kleuren[regio].hoofdkleur });
	jQuery( '#staaf_2017_uitstroom' ).css({ stroke: kleuren[regio].hoofdkleur });
	jQuery( '#staaf_2018_uitstroom' ).css({ stroke: kleuren[regio].hoofdkleur });
	jQuery( '#staaf_2019_uitstroom' ).css({ stroke: kleuren[regio].hoofdkleur });
	jQuery( '#staaf_2020_uitstroom' ).css({ stroke: kleuren[regio].hoofdkleur });
	...
	hoogte_staaf_2016_uitstroom = gegevens.jaar_2016[regio][functie].uitregio * 163 / 150000;
	hoogte_staaf_2017_uitstroom = gegevens.jaar_2017[regio][functie].uitregio * 163 / 150000;
	hoogte_staaf_2018_uitstroom = gegevens.jaar_2018[regio][functie].uitregio * 163 / 150000;
	hoogte_staaf_2019_uitstroom = gegevens.jaar_2019[regio][functie].uitregio * 163 / 150000;
	hoogte_staaf_2020_uitstroom = gegevens.jaar_2020[regio][functie].uitregio * 163 / 150000;
