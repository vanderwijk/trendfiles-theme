						...
						<ul>
							<li>
								<select class="listbox" id="opleiding_id" name="opleiding_id">
									...
									<option value="1">Assistent metaal-, elektro- en installatietechniek</option>
									<option value="2">Installeren - algemeen</option>
									<option value="3">Installeren - monteur electrotechnische installaties</option>
									<option value="4">Service apparatuur en installaties - onderhoudsmonteur installatietechniek</option>
									<option value="5">Service apparatuur en installaties - algemeen</option>
									<option value="6">Service apparatuur en installaties - inspectiemonteur koudetechniek</option>
									<option value="7">Werkvoorbereiden - algemeen</option>
									<option value="8">Service apparatuur en installaties - servicetechnicus elektrotechniek</option>
									<option value="9">Werkvoorbereiden - werkvoorbereider installatie</option>
									<option value="10">EIPS - monteur</option>
									<option value="11">Installeren - monteur werktuigkundige installaties</option>
									<option value="12">Infratechniek - monteur gas/warmte/water</option>
									<option value="13">Infratechniek - monteur data / elektra</option>
									<option value="14">Installeren - monteur koudetechniek</option>
									<option value="15">Installeren - eerste monteur electrotechnische installaties</option>
									<option value="16">Infratechniek - eerste monteur data / elektra</option>
									<option value="17">Service apparatuur en installaties - servicemonteur installatietechniek</option>
									<option value="18">Service apparatuur en installaties - servicemonteur elektrotechniek</option>
									<option value="19">Infratechniek - eerste monteur gas/warmte/water</option>
									<option value="20">Installeren - leidinggevend monteur electrotechnische installaties</option>
									<option value="21">Machinebouw mechatronica</option>
									<option value="22">Service apparatuur en installaties - servicetechnicus installatietechniek</option>
									<option value="23">Middenkader engineering</option>
									<option value="24">EIPS - eerste monteur</option>
									<option value="25">Infratechniek - algemeen</option>
									<option value="26">Werkvoorbereiden - technisch tekenaar</option>
									<option value="27">Infratechniek - technicus data / elektra</option>
									<option value="28">Dakdekker</option>
